...
import static com.contaazul.auto.selenium.assistants.AccountAssistant.createProductServiceNFeNFse;
...
public class NewMenuTest extends SeleniumTest {
	...
	public void login() throws Exception {
		...
		getAssistants().getLoginAssistant( getWebDriver() ).login(
				createProductServiceNFeNFse( createNewMenuCompanyFeature() ), "12345" );
	}

	@Test(dataProvider = DATA_PROVIDER)
	public void newMenuTest(String topMenu, String subCategory, String link, String expectedBreadcrumb) {
