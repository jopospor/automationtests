...
import static com.contaazul.auto.selenium.assistants.AccountAssistant.createProductServiceNFse;
...
public class NewMenuProductServiceNfseTest extends SeleniumTest {
	...
	public void login() throws Exception {
		...
		getAssistants().getLoginAssistant( getWebDriver() ).login(
				createProductServiceNFse( createNewMenuCompanyFeature() ), "12345" );
	}

	@Test(dataProvider = DATA_PROVIDER)
	public void newMenuProductServiceNfseTest(String topMenu, String subCategory, String link, String expectedBreadcrumb) {
