...
import static com.contaazul.auto.selenium.assistants.AccountAssistant.createFinanceControl;
...
public class NewMenuFinanceControlTest extends SeleniumTest {

	@BeforeClass
	public void login() throws Exception {
		getWebDriver().manage().window().maximize();
		getAssistants().getLoginAssistant( getWebDriver() ).login(
				createFinanceControl( createNewMenuCompanyFeature() ), "12345" );
	}

	@Test(dataProvider = DATA_PROVIDER)
	public void newMenuFinanceControlTest(String topMenu, String subCategory, String link, String expectedBreadcrumb) {
