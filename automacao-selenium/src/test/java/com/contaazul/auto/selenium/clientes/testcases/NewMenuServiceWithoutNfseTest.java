...
import static com.contaazul.auto.selenium.assistants.AccountAssistant.createServiceWithoutNFse;
...
public class NewMenuServiceWithoutNfseTest extends SeleniumTest {
	...
	public void login() throws Exception {
		...
		getAssistants().getLoginAssistant( getWebDriver() ).login(
				createServiceWithoutNFse( createNewMenuCompanyFeature() ), "12345" );
	}

	@Test(dataProvider = DATA_PROVIDER)
	public void newMenuServiceWithoutNfseTest(String topMenu, String subCategory, String link, String expectedBreadcrumb) {
