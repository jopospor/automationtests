...
import static com.contaazul.auto.selenium.assistants.AccountAssistant.createProductService;
...
public class NewMenuProductServiceTest extends SeleniumTest {
	...
	public void login() throws Exception {
		...
		getAssistants().getLoginAssistant( getWebDriver() ).login(
				createProductService( createNewMenuCompanyFeature() ), "12345" );
	}

	@Test(dataProvider = DATA_PROVIDER)
	public void newMenuProductServiceTest(String topMenu, String subCategory, String link, String expectedBreadcrumb) {
