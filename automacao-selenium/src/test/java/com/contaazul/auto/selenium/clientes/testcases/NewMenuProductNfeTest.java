...
import static com.contaazul.auto.selenium.assistants.AccountAssistant.createProductNFe;
...
public class NewMenuProductNfeTest extends SeleniumTest {
	...
	public void login() throws Exception {
		...
		getAssistants().getLoginAssistant( getWebDriver() ).login(
				createProductNFe( createNewMenuCompanyFeature() ), "12345" );
	}

	@Test(dataProvider = DATA_PROVIDER)
	public void newMenuProductNfeTest(String topMenu, String subCategory, String link, String expectedBreadcrumb) {
