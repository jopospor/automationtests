...
import static com.contaazul.auto.selenium.assistants.AccountAssistant.createServiceNFse;
...
public class NewMenuServiceNfseTest extends SeleniumTest {
	...
	public void login() throws Exception {
		...
		getAssistants().getLoginAssistant( getWebDriver() ).login(
				createServiceNFse( createNewMenuCompanyFeature() ), "12345" );
	}

	@Test(dataProvider = DATA_PROVIDER)
	public void newMenuServiceNfseTest(String topMenu, String subCategory, String link, String expectedBreadcrumb) {
